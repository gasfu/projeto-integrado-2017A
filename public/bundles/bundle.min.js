...
var _smoothscroll = __webpack_require__(123);

var _smoothscroll2 = _interopRequireDefault(_smoothscroll);

var _ElevatorController = __webpack_require__(145);

var _ElevatorController2 = _interopRequireDefault(_ElevatorController);

var _AnimationController = __webpack_require__(143);

var _AnimationController2 = _interopRequireDefault(_AnimationController);

var _MachineController = __webpack_require__(146);

var _MachineController2 = _interopRequireDefault(_MachineController);

var _AptController = __webpack_require__(144);

var _AptController2 = _interopRequireDefault(_AptController);
...
var floorsName = ["ground", "first", "second", "third", "fourth", "fifth"];

var elevatorController = new _ElevatorController2.default();
var animationController = new _AnimationController2.default();
var machineController = new _MachineController2.default();
var aptController = new _AptController2.default();

//Add action in control
var controlButtons = document.querySelectorAll("[control-action-move]");
...
var controlHelperButton = document.querySelector("[control-action-helper]");
controlHelperButton.addEventListener("click", function () {
	window.open("https://github.com/gasfu/projeto-integrado-2017A");
});

var openDoorButtons = document.querySelectorAll("[open-action]");
openDoorButtons.forEach(function (button) {
...
var cat = document.querySelector("[cat-action]");
cat.addEventListener("mouseover", function () {
	animationController.cat();
});

var sky = document.querySelector(".floor.--fifth");
			...
			while (1) {
				switch (_context.prev = _context.next) {
					case 0:
						...
						_context.next = 3;
						return machineController.getProducts();

					case 3:
						products = _context.sent;
						html = products.data.map(machineController.prepareItemHtml).join("");
...
(function () {
	var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
		var machine, apts, html;
		return regeneratorRuntime.wrap(function _callee2$(_context2) {
			while (1) {
				switch (_context2.prev = _context2.next) {
					case 0:
						machine = document.querySelector("[data-apts]");
						_context2.next = 3;
						return aptController.getApts();

					case 3:
						apts = _context2.sent;
						html = apts.data.map(aptController.prepareItemHtml).join("");
...
var machine = document.querySelector("[open-machine]");
machine.addEventListener("click", aptController.open);

var formAuthenticate = document.querySelector("[authenticate-submit]");
var inputPassword = document.querySelector("[input-passoword]");

inputPassword.addEventListener("keydown", function (e) {
	formAuthenticate.item.forEach(function (row) {
		return row.addEventListener("change", aptController.cleanAfd);
	});
	e.preventDefault();
	if (inputPassword.value.length == 0) aptController.openAfd();
	var auth = aptController.authenticate(e, formAuthenticate);
...
var buyed = document.querySelector("[buy-submit]");
buyed.addEventListener("submit", function (e) {
	e.preventDefault();
	var buy = aptController.buy(e);
});

var closed = document.querySelector("[close-submit]");
closed.addEventListener("submit", function (e) {
	e.preventDefault();
	...
	_createClass(AnimationController, [{
		...
		value: function cloud(sky) {
			...
			var pause = function pause() {
				_this.trovaoAudio.pause();
				_this.birdAudio.pause();
			};
...
var AptController = function () {
	...
	_createClass(AptController, [{
					...
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								...
								_context.prev = 1;
								_context.next = 4;
								return _axios2.default.get("/objects/apts.json");
							...
							case 10:
								return _context.abrupt("return", JSON.parse(JSON.stringify(response.data)));
		...
		key: "cleanAfd",
		value: function cleanAfd() {
			var afdItens = Array.from(document.querySelectorAll("[afd-item]"));
			var inputPassword = document.querySelector("[input-passoword]");
			inputPassword.value = "";

			afdItens.forEach(function (item) {
		...
		key: "prepareItemHtml",
		value: function prepareItemHtml(item) {
			var html = "";
		...
		key: "open",
		value: function open() {
			var machine = document.querySelector(".machine-wrapper.--login");
			machine.classList.remove("--hide");
		}
	}, {
		key: "authenticate",
		value: function () {
			var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(e, form) {
				var item, password, response, apts, apt, data, length;
				return regeneratorRuntime.wrap(function _callee2$(_context2) {
					while (1) {
						switch (_context2.prev = _context2.next) {
							case 0:
								item = form.item, password = form.password;
								_context2.next = 3;
								return _axios2.default.get("/objects/apts.json");

							case 3:
								response = _context2.sent;
								apts = JSON.parse(JSON.stringify(response.data));
								apt = apts.data.filter(function (apt) {
									return apt.code == item.value;
								})[0];
								data = { password: password.value, length: password.value.length };
								...
								return _context2.abrupt("return", { password: password.value + e.key, length: password.value.length + 1, validated: true });

							case 10:
								return _context2.abrupt("return", _extends({}, data, { validated: false }));
		...
		value: function buy(e) {
			...
			setTimeout(function () {
				var machine = document.querySelector(".machine-wrapper.--buyed");
				var feed = document.querySelector(".machine-wrapper.--feedback");
		...
		key: "renderSuccess",
		value: function renderSuccess(length) {
			var afdItens = Array.from(document.querySelectorAll("[afd-item]"));
			console.log(afdItens);
			afdItens.slice(0, length).forEach(function (item) {
				item.classList.remove('--error');
		...
		key: "renderError",
		value: function renderError(length) {
			var item = document.querySelectorAll("[afd-item]")[length];
			item.classList.add('--error');
		}
	}, {
		key: "openAfd",
		value: function openAfd() {
			var item = document.querySelector("[afd]");
...
var ElevatorController = function () {
	function ElevatorController() {
		_classCallCheck(this, ElevatorController);
	...
	_createClass(ElevatorController, [{
		key: "move",
		value: function move(section, value) {
			var _this = this;

			this.control.classList.add("--hide");
			var time = Math.abs(window.localStorage.getItem("floor") - value) * 3000;
			var floor = document.querySelector("#" + section);

			var openNextDoor = function openNextDoor() {
				_this.elevatorAudio.pause();
				_this.endElevatorAudio.play();
				setTimeout(function () {
					var nextDoor = document.querySelector("#" + section + " .open");
					_this.openDoor(nextDoor, false);
				}, 1500);
			};
			...
			this.closeDoor(function () {
				(0, _smoothscroll2.default)(floor, time, openNextDoor);
			});
		...
		key: "showControl",
		value: function showControl(door) {
			var _this2 = this;

			var remove = function remove() {
				_this2.control.classList.remove("--hide");
			};
...
var MachineController = function () {
	...
	_createClass(MachineController, [{
					...
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								...
								_context.prev = 1;
								_context.next = 4;
								return _axios2.default.get("/objects/products.json");
		...
		value: function open() {
			setTimeout(function () {
				var machine = document.querySelector(".machine-wrapper");
				var auth = document.querySelector(".machine-wrapper.--login");

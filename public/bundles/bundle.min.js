...
formAuthenticate.addEventListener("submit", function (e) {
	e.preventDefault();
	var auth = aptController.authenticate(e);
	...
	_createClass(AptController, [{
		...
		value: function () {
			var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(e) {
				var _e$target, item, password, response, apts, validate, isValid;
				...
				return regeneratorRuntime.wrap(function _callee2$(_context2) {
					while (1) {
						switch (_context2.prev = _context2.next) {
							case 0:
								e.preventDefault();
								_e$target = e.target, item = _e$target.item, password = _e$target.password;
								_context2.next = 4;
								return _axios2.default.get("/objects/apts.json");
							...
							case 4:
								...
								validate = function validate(apt) {
									return apt.code == item.value && apt.password == password.value;
								};

								console.log(apts);

								isValid = apts.data.filter(validate);
								return _context2.abrupt("return", !!isValid.length);
...
var ElevatorController = function () {
	...
	_createClass(ElevatorController, [{
		...
		value: function _setGround() {
			var section = document.querySelector("#ground");

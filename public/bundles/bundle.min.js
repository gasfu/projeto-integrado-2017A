...
var _smoothScroll = __webpack_require__(300);

var _smoothScroll2 = _interopRequireDefault(_smoothScroll);

var _ElevadorController = __webpack_require__(116);

var _ElevadorController2 = _interopRequireDefault(_ElevadorController);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

window.localStorage.setItem("floor", 4);
var floors = ["ground", "first", "second", "third", "fourth"];

//Add action in control
var controlButtons = document.querySelectorAll("[control-action-move]");
controlButtons.forEach(function (button) {
	button.addEventListener("click", function (button) {
		_ElevadorController2.default.move(floors[button.target.value], button.target.value);
	});
});
...
var ElevadorController = function () {
	function ElevadorController() {
		_classCallCheck(this, ElevadorController);
	}

	_createClass(ElevadorController, null, [{
		key: "move",
		value: function move(section, value) {
			...
			(0, _smoothScroll2.default)(section, time);
	...
	return ElevadorController;
}();

exports.default = ElevadorController;
